...
public class BluetoothScanActivity extends AppCompatActivity implements Bluetooth.DiscoveryCallback, AdapterView.OnItemClickListener {
    ...
    public void onPair(BluetoothDevice device) {
        setProgressVisibility(View.INVISIBLE);
        setText("Paired!");
        Intent i = new Intent(BluetoothScanActivity.this, BluetoothActivity.class);
        startActivity(i);
        finish();
    }
